<nav x-data="{ open: false }" class="bg-lime-300 border-b border-gray-100 fixed top-0 left-0 w-full z-10">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                        ...
                        <x-dropdown align="right" width="60">
                            <x-slot name="trigger">
                                <span class="inline-flex rounded-md">
                                    <button type="button"
                                        class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-lime-300 hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
                ...
                <!-- Settings Dropdown -->
                <div class="ms-3 relative">
                    <x-dropdown class="bg-lime-300" align="right" width="48">
                        <x-slot name="trigger">
